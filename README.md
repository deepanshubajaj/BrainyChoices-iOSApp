<h1 align="center">Brainy Choices - iOS App</h1>

**Brainy Choices** is a fun and engaging Quiz app that tests your knowledge with multiple-choice questions! Whether you're preparing for a trivia night or just love challenges, this app provides an entertaining and educational experience. Answer questions, see your score, and challenge yourself to improve your knowledge!

## Features :

- **Multiple-Choice Questions**: Answer a series of questions with multiple-choice options.
- **Interactive UI**: A simple and colorful design that makes taking quizzes enjoyable for all ages.
...
1. Clone the repository:
    ```bash
    git clone https://github.com/deepanshubajaj/BrainyChoices-iOSApp.git
    ```

2. Open the project in Xcode:
    ```bash
    open BrainyChoices.xcodeproj
    ```
...
<p align="center">
  *Screenshots of the Brainy Choices app showing different stages of the main quiz screen.*
</p>
...
<p align="center">
  *The app icon reflects the fun, educational theme of the Brainy Choices app.*
</p>
